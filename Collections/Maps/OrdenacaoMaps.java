...
public class OrdenacaoMaps {
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, Livro> livro : meusLivros4)
            System.out.println(
                livro.getKey() + " - " + livro.getValue().getNome() + " - " + livro.getValue().getPaginas()
                );
...
class ComparatorPagina implements Comparator<Map.Entry<String, Livro>>{
    ...
    public int compare(Map.Entry<String, Livro> l1, Map.Entry<String, Livro> l2) {
        ...
        int numPaginas = Integer.compare(l1.getValue().getPaginas(), l2.getValue().getPaginas());
        if (numPaginas != 0) return numPaginas;
