...
public class Mapsmain{
    public static void main(String[] args) {
        ...
        */
        ...
        //        System.out.println("Exiba o terceiro modelo adicionado: "); não suporta essa operação
        ...
        System.out.println("\nConfira se o dicionario esta vazio: " + carrosPopulares + " -> " + carrosPopulares.isEmpty());
