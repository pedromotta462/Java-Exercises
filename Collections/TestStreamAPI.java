...
//        Para você
        ...
        long countNumerosUnicos = numerosAleatoriosInteger.stream()
                .distinct()
                .count();
        System.out.println("\nRetirando os numeros repetidos da lista, quantos numeros ficam? " + countNumerosUnicos);
        ...
        int somaDosNumerosPares = numerosAleatoriosInteger.stream()
                ...
                .mapToInt(Integer::intValue)
                .sum();
        System.out.println("\nPegue apenas os numeros impares e some: " + somaDosNumerosPares);
        ...
        System.out.println("\nAgrupe os valores impares multiplos de 3 ou de 5:");
